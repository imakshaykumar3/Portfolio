...
const SKILLS = [
  ...
  },
  {
    ...
    skills: [
      ...
      { name: "Microservices", icon: FaProjectDiagram, color: "#A855F7" },
      { name: "JWT Authentication", icon: FaKey, color: "#F59E0B" },
      { name: "WebSockets", icon: FaExchangeAlt, color: "#06B6D4" },
      { name: "Async Programming", icon: FaBolt, color: "#10B981" },
      { name: "Pydantic", icon: FaCube, color: "#EC4899" },
    ],
  },
  {
  ...
  },
  {
    ...
    skills: [
      ...
      { name: "ChromaDB", icon: FaLayerGroup, color: "#8B5CF6" },
      { name: "Pinecone", icon: FaNetworkWired, color: "#14B8A6" },
      { name: "FAISS", icon: FaServer, color: "#F97316" },
    ],
  },
  {
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        {/* Glows: Purple top-right (matching your text), Cyan bottom-left */}
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_right,rgba(168,85,247,.10),transparent_35%)]" />
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_bottom_left,rgba(34,211,238,.10),transparent_35%)]" />
      ...
      <div className="section-container relative z-10">
        ...
        <FadeIn>
          <h2 className="mb-12 font-display text-5xl md:text-6xl font-black uppercase tracking-wider text-white">
            Technical{" "}
